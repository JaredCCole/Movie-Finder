...
class IMDbConnector:
	...
	def getURL(self):
		...
		return "https://imdb-api.com/API/AdvancedSearch/" + self.apiKey + "?" + self.titleType + self.releaseMinMax + self.userRatingMinMax + self.numOfVotesMinMax + self.genre + self.count
